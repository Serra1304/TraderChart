...
//        chartController.setCandleSize(ElementDimension.VERY_SMALL);
//        assertEquals(ElementDimension.VERY_SMALL, chartController.getCandleSize());
//
//        chartController.setCandleSize(ElementDimension.SMALL);
//        assertEquals(ElementDimension.SMALL, chartController.getCandleSize());
//
//        chartController.setCandleSize(ElementDimension.VERY_LARGE);
//        assertEquals(ElementDimension.VERY_LARGE, chartController.getCandleSize());
//
//        chartController.setCandleSize(ElementDimension.LARGE);
//        assertEquals(ElementDimension.LARGE, chartController.getCandleSize());
//    }
//
//    @Test
